...
/tmp/squashfs-root/usr/bin/appimagetool $HOME/squashfs-root -u "gh-releases-zsync|pineappleEA|Pineapple-Linux-Binary|continuous|yuzu-x86_64.AppImage.zsync"
